...
import { ArrowLeft, MapPin, Globe, Users, Tv, Calendar } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f0f5f9]">
      <div className="container mx-auto px-4 py-8">
        <Link href="/">
          <Button
            variant="outline"
            className="mb-8 h-12 px-6 border-3 border-black bg-white hover:bg-gray-100 font-black neo-shadow neo-hover"
          >
          ...
          <div className="space-y-6">
            ...
            <Card className="border-4 border-black bg-white neo-shadow-lg p-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Badge
                  className={`${statusColors[character.status]} border-3 font-black uppercase text-sm px-4 py-2`}
                >
                  {character.status}
                </Badge>
            ...
            <Card className="border-4 border-black bg-white neo-shadow-lg">
              <CardContent className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-3 p-4 border-3 border-black bg-[#f9ca24]">
                  ...
                  <div>
                    <p className="text-xs font-black uppercase text-gray-700">Gender</p>
                ...
                <div className="flex items-start gap-3 p-4 border-3 border-black bg-[#00b5cc] text-white">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-lg font-black wrap-break-word">{character.origin.name}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 border-3 border-black bg-[#84d65a]">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-black uppercase">Last Known Location</p>
                    <p className="text-lg font-black wrap-break-word">{character.location.name}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 border-3 border-black bg-[#ee5a6f] text-white">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-black">{character.episode.length} Episodes</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 border-3 border-black bg-gray-100">
                  ...
                  <div>
                    <p className="text-xs font-black uppercase text-gray-700">Created</p>
